...
const s = {
  ...
  modal: { background: '#111', border: '1px solid #333', borderRadius: 12, padding: 20, maxWidth: 480, width: '100%', maxHeight: '80vh', display: 'flex', flexDirection: 'column', color: '#fff' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 },
  title: { color: '#888', fontSize: 12, fontWeight: 700, letterSpacing: 1 },
  ...
  muted: { color: '#666', fontSize: 13, fontStyle: 'italic', margin: 'auto' },
  ...
  bubble: (mine) => ({
    ...
    background: mine ? '#00e5ff' : '#1a1a1a', color: mine ? '#000' : '#eee',
    border: mine ? 'none' : '1px solid #262626',
  }),
  ...
  input: { flex: 1, padding: '10px 12px', background: '#000', border: '1px solid #333', borderRadius: 6, color: '#fff', fontSize: 13 },
  sendButton: { padding: '10px 16px', background: '#00e5ff', border: 'none', borderRadius: 6, fontWeight: 700, cursor: 'pointer', fontSize: 12 },
};
