...
const s = {
  ...
  modal: { background: 'var(--bg-elevated)', border: '1px solid var(--border-strong)', borderRadius: 12, padding: 24, maxWidth: 600, width: '100%', maxHeight: '85vh', overflowY: 'auto', color: 'var(--text-primary)' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 },
  name: { fontSize: 22, fontWeight: 700 },
  contact: { color: 'var(--text-secondary)', fontSize: 13, marginTop: 4 },
  ...
  productChip: { fontSize: 11, color: 'var(--accent)', border: '1px solid var(--border-accent)', padding: '4px 10px', borderRadius: 12 },
  noProducts: { color: 'var(--text-muted)', fontSize: 12, fontStyle: 'italic' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10, marginBottom: 24 },
  summaryBox: { background: 'var(--bg-sunken)', border: '1px solid var(--border-hairline)', borderRadius: 8, padding: 12, textAlign: 'center' },
  summaryValue: { fontSize: 20, fontWeight: 700, color: 'var(--accent)' },
  summaryLabel: { fontSize: 10, color: 'var(--text-muted)', marginTop: 2 },
  section: { marginBottom: 20 },
  sectionTitle: { fontSize: 11, color: 'var(--text-muted)', letterSpacing: 1, marginBottom: 10 },
  timeline: { borderLeft: '2px solid var(--border-hairline)', paddingLeft: 14 },
  timelineRow: { marginBottom: 10 },
  timelineTime: { color: 'var(--text-muted)', fontSize: 10 },
  timelineLabel: { color: 'var(--text-secondary)', fontSize: 13, marginTop: 2 },
  empty: { color: 'var(--text-muted)', fontStyle: 'italic', fontSize: 13 },
  oppRow: { color: 'var(--text-secondary)', fontSize: 13, padding: '6px 0', display: 'flex', gap: 8, alignItems: 'center' },
  oppType: (type) => ({
