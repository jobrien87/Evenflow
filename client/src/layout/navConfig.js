...
export const NAV_BY_ROLE = {
  ...
  AGENCY_OWNER: [
    ...
    { label: 'Settings', to: '/agency/settings', icon: 'gear' },
  ...
  PLATFORM_OWNER: [
    ...
    { label: 'Credit Requests', to: '/platform/credits', icon: 'ticket', primary: true },
    { label: 'Support', to: '/platform/support', icon: 'support' },
